...
## Option A — Outcome-led (recommended hero)

NOW OPEN — OLONGAPO
**BUILT TO MOVE BETTER**
URBN Athletics — coached fitness for real, lasting results.
...
**Try it FREE — 2 sessions of FIT45 or URBN HYBRID**
Walk in and ask our team to start.
Built to Move Better

---

## Option C — Free-trial / action-led (most walk-ins)
...
- Hero banner: **Option A** (brand promise, premium feel).
- Highest walk-in pull: **Option C** (free offer as headline).
- Run A + C on two banners if budget allows. Use B if reassuring current/old members is the priority.
- Suggested print size: landscape 3×6 ft (entrance) or 4×8 ft (street-facing). Keep headline readable from ~10 m.
